...
<body class="" style="overflow:hidden;">
  <div class="wrapper ">
    ...
    <div class="main-panel">
      ...
      <!-- end nav bar -->
      <div class="content" >
        <div class=" bg-white p-0" style="height: calc(100vh-42px); display: flex;">
          <div id="convo-list-div" class="col col-md-5 col-lg-4 bg-light bg-opacity-25 row-cols-1" style="height: calc(100vh - 42px) !important;">
