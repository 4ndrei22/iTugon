            ...
            while($row = mysqli_fetch_assoc($query)){
                ...
                if($row['outgoing_msg_id'] === $outgoing_id){
                    $output .= '<div><div class="d-flex flex-row-reverse mt-2"> 
                                    <div class="outgoing-chat py-2 px-3" Style="max-width: 80%; background-color: #671e1e;">
                    ...
                    $output .= '<div class="d-flex my-2">
                                    <img class="rounded-circle p-0 align-self-top me-2" src="../Super Admin/images/'.$row['img'].'" width="28px" height="28px">
                                    <div style="max-width: 80%; ">
                                        <div class="py-2 px-3 bg-secondary incoming-chat" Style="">
