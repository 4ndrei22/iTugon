...
<body class="">
    <div class="wrapper ">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown ">
                        ...
                        <div class="dropdown-content" >
                            <a href="./Super Admin/Ticket(open)">Open</a>
                            <a href="./Super Admin/Ticket(Pending)">Pending</a>
                            <a href="./Super Admin/Ticket(reopened)">Reopened</a>
                            <a href="./Super Admin/Ticket(assigned)">Assigned</a>
                        </div>
                    </li>
                    <li>
                        <a href="Super Admin/FAQs(create)">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                <div class="row" id="tickets" >
                    ...
                    <!-- Open ticket -->
                    <div class=" col"id="OpenTicket">
                        <a href="./Super Admin/Ticket(open)" style="text-decoration:none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-7 col-md-8">
                                            <div class="numbers">
                                                <?php
                                                    include 'connect.php';
                                                    $open = "SELECT * FROM ticketinfo WHERE status='Open'";
                                                    if ($openres = mysqli_query($con, $open)) {
                                                    // Return the number of rows in result set
                                                    $openrescount = mysqli_num_rows( $openres );
                                                    }
                                                ?>
                                                <p class="card-category text-white">Open</p>
                                                <p class="card-title text-white"><?php echo $openrescount; ?><p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Pending ticket -->
                    <div class=" col"id="PendingTicket">
                        <a href="./Super Admin/Ticket(Pending)" style="text-decoration:none;">
                                        ...
                                        <div class="col-7 col-md-8">
                                            <div class="numbers">
                                                <?php
                                                    ...
                                                    $pending = "SELECT * FROM ticketinfo WHERE status='Pending'";
                                                    if ($pendingres = mysqli_query($con, $pending)) {
                                                    // Return the number of rows in result set
                                                    $pendingrescount = mysqli_num_rows( $pendingres );
                                                    }
                                                ?>
                                                <p class="card-category text-white">Pending</p>
                                                <p class="card-title text-white"><?php echo $pendingrescount; ?><p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Reopen ticket -->
                    <div class=" col"id="ReopenedTicket">
                        <a href="./Super Admin/Ticket(reopened)" style="text-decoration:none;">
                                        ...
                                        <div class="col-7 col-md-8">
                                            <div class="numbers">
                                                <?php
                                                    include 'connect.php';
                                                    //$sql = "SELECT Firstname, Lastname FROM staffs";
                                                    $reopened = "SELECT * FROM ticketinfo WHERE status='Reopened'";
                                                    if ($reopenedres = mysqli_query($con, $reopened)) {
                                                    // Return the number of rows in result set
                                                    $reopenedrescount = mysqli_num_rows( $reopenedres );
                                                    }
                                                 ?>
                                                <p class="card-category text-white">Reopened</p>
                                                <p class="card-title text-white"><?php echo $reopenedrescount; ?><p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Resolved ticket -->
                    <div class="col "id="ResolvedTicket">
                        <a href="./Super Admin/Ticket(Resolved)" style="text-decoration:none;">
                                        ...
                                        <div class="col-7 col-md-8">
                                            <div class="numbers">
                                                <?php
                                                    include 'connect.php';
                                                    //$sql = "SELECT Firstname, Lastname FROM staffs";
                                                    $resolved = "SELECT * FROM ticketinfo WHERE status='Resolved'";
                                                    if ($resolvedres = mysqli_query($con, $resolved)) {
                                                        // Return the number of rows in result set
                                                        $resolvedrescount = mysqli_num_rows( $resolvedres );
                                                    }
                                                ?>  
                                                <p class="card-category text-white">Resolved</p>
                                                <p class="card-title text-white"><?php echo $resolvedrescount; ?><p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- Closed ticket -->
                    <div class=" col"id="ClosedTicket">
                        <a href="./Super Admin/Ticket(Closed)" style="text-decoration:none;">
                                        ...
                                        <div class="col-7 col-md-8">
                                            <div class="numbers">
                                                <?php
                                                    include 'connect.php';
                                                    //$sql = "SELECT Firstname, Lastname FROM staffs";
                                                    $closed = "SELECT * FROM ticketinfo WHERE status='Closed'";
                                                    if ($closedres = mysqli_query($con, $closed)) {
                                          
                                                        // Return the number of rows in result set
                                                        $closedrescount = mysqli_num_rows( $closedres );
                                                    }
                                                ?>
                                                <p class="card-category text-white">Closed</p>
                                                <p class="card-title text-white"><?php echo $closedrescount; ?><p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card shadow mb-2">
                            ...
                            <div class="card-body">
                                <h4 id="satisfy" class="small font-weight-bold">Very Satisfied
                                ...
                                <h4 id="satisfy" class="small font-weight-bold">Satisfied
                                    <span class="float-right">30%</span>
                                </h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: 30%" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 id="satisfy" class="small font-weight-bold">Good
                                    <span class="float-right">15%</span>
                                </h4>
                                <div class="progress mb-4">
                                    <div class="progress-bar" role="progressbar" style="width: 15%"aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <h4 id="satisfy" class="small font-weight-bold">Unsatisfied 
                                ...
                                <h4 id="satisfy" class="small font-weight-bold">Very Unsatisfied
        ...
        <script>
            ...
            var barColors = ["#f0ad4e","#d9534f","#5bc0de","#292b2c",];
            new Chart("piechart", {
                type: "doughnut",
                data: {
                labels: xValues,
        ...
        <script>
            var config = {
                    ...
                    data: {
                        ...
                        datasets: [{
                            backgroundColor: ['rgb(2, 117, 216)','rgb(240, 173, 78)','rgb(217, 83, 79)','rgb(91, 192, 222)'],
                            borderColor: ['rgb(2, 117, 216)','rgb(240, 173, 78)','rgb(217, 83, 79)','rgb(91, 192, 222)'],
                            data: [1, 2, 2, 0],
                        }]
                    },
                    options: {
